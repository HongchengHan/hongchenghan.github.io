...
is_owner: true
name:
  display: Han Hongcheng
  given: Hongcheng
  family: Han
  alternate: '韩泓丞'  # Example: 王伟
...
status:
  icon: "☕️"
role: PhD Candidate in Control Science and Engineering
bio: |
  Hongcheng Han (韩泓丞) received the degree of B.Eng. in School of Energy and Power Engineering, Xi’an Jiaotong University, Xi’an, China in 2020. 
...
links:
  - icon: at-symbol
    url: mailto:hanhc@stu.xjtu.edu.cn
    label: E-mail Me
  - icon: brands/x
    url: https://x.com/Mainsail9999
  - icon: brands/github
    url: https://github.com/hongchenghan
  # - icon: brands/linkedin
  #   url: https://www.linkedin.com/in/example/
  - icon: academicons/google-scholar
    url: https://scholar.google.com/citations?user=KhaN2PgAAAAJ&hl=zh-CN
  - icon: academicons/orcid
    url: https://orcid.org/0009-0000-7759-6058
...
education:
  - degree: PhD Candidate in Control Science and Engineering
    institution: Xi’an Jiaotong University
    start: 2026-09
    end: 2027-06
    # summary: |
    #   Thesis on medical image analysis. Published 2 papers in MedIA and JBHI.
    # button:
  ...
  #   start: 2020-09
  #   end: 2022-09
  - degree: BS Energy and Power Engineering
    institution: Xi’an Jiaotong University
    start: 2016-09
    end: 2020-06
